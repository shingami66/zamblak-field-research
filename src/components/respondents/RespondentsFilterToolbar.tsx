...
import styles from "@/app/respondents/respondents-list.module.css";

export interface RespondentsFilterToolbarProps {
  name?: string;
...
export function RespondentsFilterToolbar({
  initialSearch = null,
  copy,
}: RespondentsFilterToolbarProps) {
