...
export const projectsCreateCopy = {
  ...
  pageDescription:
    "أدخل بيانات المشروع التشغيلية واربطه بشركة نشطة. الحقول المطلوبة مميزة.",
  backToList: "العودة إلى قائمة المشاريع",
  draftNotice:
    "سيُنشأ المشروع بحالة نشط، ويمكنك إضافة المشاركين مباشرة بعد الإنشاء.",
  ...
  domainLabel: "مجال المشروع",
  domainRequired: "مطلوب",
  domainPlaceholder: "مثال: الاتصالات، الرعاية الصحية، الأغذية، التعليم",
  domainHint: "اكتب مجال البحث المناسب للمشروع، بحد أقصى 120 حرفًا.",
