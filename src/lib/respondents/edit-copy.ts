...
export const respondentsEditCopy = {
  pageTitle: "تعديل المشارك",
  pageDescription:
    "حدّث بيانات المشارك في السجل. رقم الجوال مطلوب. إذا عدّل شخص آخر السجل، أعد التحميل قبل الحفظ.",
  loading: "جاري تحميل نموذج تعديل المشارك…",
  backToDetail: "العودة إلى تفاصيل المشارك",
  backToList: "العودة إلى سجل المشاركين",
  optional: "اختياري",
  required: "مطلوب",
  ...
  reloadRecord: "إعادة تحميل أحدث بيانات المشارك",
  ...
  errorStale:
    "تم تعديل بيانات هذا المشارك من مكان آخر بعد تحميل الصفحة. أعد التحميل ثم أدخل التعديلات مرة أخرى. لا يُعاد الحفظ تلقائياً.",
  errorNotFound:
    "لم يعد هذا المشارك متاحاً. قد يكون الرابط غير صالح أو السجل غير موجود.",
  errorAccess:
    "لا يمكن تعديل هذا المشارك بهذا الحساب. تحقق من الصلاحية أو أعد تسجيل الدخول.",
  errorUnexpected: "تعذّر حفظ تعديلات المشارك. حاول مرة أخرى لاحقاً.",
} as const;
