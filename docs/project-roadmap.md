...
- **New Project Default (DEV applied, browser acceptance pending):** New Projects are created `active` (DEC-PROJECT-001, approved 2026-08-04). Migration `20260804001500_create_projects_active_by_default.sql` was **manually applied by Mozfer on DEV** (2026-08-04) and **catalog-validated** — runtime database enforcement is confirmed (`projects.status` default `active`; `create_project` inserts `active`; no backfill). Browser acceptance of the newly-created-active-Project flow remains pending; precommit and commit remain pending; no phase closure or production-readiness claim.
...
- **Status:** IN PROGRESS
- **Active Slice:** The first bounded Phase 1 slice is the Owner Researcher Research Form submission workflow; the Screen Contract exists and the Research Form submission Data Contract remains approved by Mozfer (2026-08-03) as subordinate design artifacts under `docs/contracts/`; the Research Form submission Wireframe remains approved by Mozfer (2026-08-03) under `docs/wireframes/`; DEC-FORM-001 through DEC-FORM-006 remain approved in `docs/deferred-decisions.md` (approved 2026-08-03); the Data Contract approval gate is complete; the Wireframe approval gate is complete; the Research Form submission Visual Specification is approved by Mozfer on 2026-08-03 under `docs/visual-specifications/`; the Visual Specification approval gate is complete; it governs presentation improvements to the existing `/forms/new` page; rebuilding `/forms/new` remains unauthorized; the Implementation Slice is now the next incomplete delivery stage; implementation remains separately authorized and not started; consolidated review, correction, browser acceptance, and Phase 1 closure remain incomplete; Phase 1 remains IN PROGRESS.
