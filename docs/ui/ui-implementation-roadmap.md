...
- Branded loading mark: **implemented** (compact/standard/full + reduced-motion; Projects loading/pending + root main loading); Mozfer smoke **PASS WITH WARN**.
